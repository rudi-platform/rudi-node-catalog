...
} from '../controllers/metadataController.mjs'
import {
...
import { dropCollection, dropDB, getCollections } from '../controllers/dbController.mjs'
import {
  getApiVersion,
  getAppHash,
  getEnvironment,
  ...
  getNodeVersion,
  serveFavicon,
} from '../controllers/sysController.mjs'
import { getLogs, searchLogs } from '../controllers/logController.mjs'

import {
  getEveryThesaurus,
  getSingleThesaurus,
  getSingleThesaurusLabels,
} from '../controllers/skosController.mjs'
import {
  getAllLicenceCodes,
  getAllLicences,
  initLicences,
} from '../controllers/licenceController.mjs'
...
import {
  ...
  getMetadata,
  sendMetadata,
} from '../controllers/portalController.mjs'
import { getSinglePubKey } from '../controllers/publicKeyController.mjs'
