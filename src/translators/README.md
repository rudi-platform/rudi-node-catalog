...
This document explains the structure of translation, used to import (and export lately) object at different standards and format to RUDI.
...
For each couple (STANDARD, FORMAT) that you want to translate objects from, you need to create instances of Object Translator. An **Object Translator** is used to translate an object at a different standard and/or format than RUDI's ones to RUDI (ex: ISO1915 (GMD-XML) to RUDI; or DCAT to RUDI).
