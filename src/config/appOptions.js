...
export const OPTIONS = {
  ...
  [OPT_APP_ENV]: {
    ...
    cli: 'app_env',
    env: 'RUDI_CATALOG_ENV',
    alt: 'RUDI_API_ENV',
  },
  [OPT_GIT_HASH]: {
    text: 'Git hash',
    cli: 'hash',
    env: 'RUDI_CATALOG_GIT_REV',
    alt: 'RUDI_API_GIT_REV',
  },
  [OPT_PORT]: {
    text: 'RUDI Catalog server listening port',
    cli: 'port',
    env: 'RUDI_CATALOG_PORT',
    alt: 'RUDI_API_PORT',
  },
  [OPT_PUBLIC_URL]: {
    text: 'RUDI Catalog server public URL',
    cli: 'url',
    env: 'RUDI_CATALOG_URL',
    alt: 'CATALOG_PUBLIC_URL',
  },
  [OPT_USER_CONF]: {
    text: 'User conf file',
    cli: 'conf',
    env: 'RUDI_CATALOG_USER_CONF',
    alt: 'RUDI_API_USER_CONF',
  },
  [OPT_PROFILES_CONF]: {
    text: 'Profiles conf file',
    cli: 'profiles',
    env: 'RUDI_CATALOG_PROFILES_CONF',
    alt: 'RUDI_API_PROFILES_CONF',
  },
  [OPT_PORTAL_CONF]: {
    text: 'Portal conf file',
    cli: 'portal_conf',
    env: 'RUDI_CATALOG_PORTAL_CONF',
    alt: 'RUDI_API_PORTAL_CONF',
  },
}
