...
exports.newOrganization = async (orgJson) => {
  ...
  try {
    ...
    log.w(mod, fun, `New object '${URL_OBJECT_ORGANIZATIONS}': ${utils.beautify(orgJson)} | Error: ${err}`)
    log.e(mod, fun, err)
    throw err
  }
  try {
    ...
    log.w(mod, fun, `Saving object '${URL_OBJECT_ORGANIZATIONS}': ${utils.beautify(dbOrganization)} | Error: ${err}`)
    log.e(mod, fun, err)
    throw err
  }
