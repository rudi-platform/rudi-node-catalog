...
import { HEADERS, HD_AUTH, HD_URL, HD_AUTH_LOWER, HD_METHOD } from '../config/headers.mjs'
...
// ------------------------------------------------------------------------------------------------
import { HTTP_METHODS } from '../config/confApi.mjs'
import { logT } from './logging.mjs'
...
import {
  ...
  REGEX_BASIC_AUTH,
} from '../definitions/schemaValidators.mjs'
// ------------------------------------------------------------------------------------------------
// Functions
// ------------------------------------------------------------------------------------------------
/**
